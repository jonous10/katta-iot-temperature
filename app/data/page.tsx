                ...
                {hasPermission("VIEW_TEMPERATURE") ? (
                        ...
                        {hasPermission("VIEW_TEMPERATURE_HISTORY") ? (
                            <section className="bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                                <div className="mb-6">
                                    ...
                                    <p className="text-gray-600">Analyze temperature trends over time</p>
                                </div>
                                <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                    <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                                        <h2 className="text-lg font-semibold text-gray-800">Temperature History</h2>
                                        <p className="text-gray-600 text-sm mt-1">Raw sensor readings</p>
                                    </div>
                                        ...
                                        <thead className="bg-gray-50 border-b border-gray-200">
                                            <tr>
                                                <th
                                                    ...
                                                    className="cursor-pointer px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-left"
                                                >
                                                ...
                                                {canDelete && (
                                                    <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-left">
                                                        Actions
                                                    </th>
                                                )}
                                            </tr>
                                            ...
                                            {sortedData.length > 0 ? (
                                                sortedData.map((row, idx) => (
                                                    <tr key={idx} className="hover:bg-gray-50">
                                                        <td className="px-6 py-4 text-gray-800">{row.ts}</td>
                                                        <td className="px-6 py-4 text-gray-800">{row.temperature}</td>
                                                        {canDelete && (
                            ...
                            <div className="flex justify-center items-center">
                                <section className="bg-white rounded-full border border-gray-200 shadow-lg p-6 mx-auto my-auto inline-block">
                                    <div className="text-center my-10">
                                        ...
                                        <p className="text-gray-600">Live reading from your IoT sensors</p>
                                    </div>
                    ...
                    <div className="flex items-center justify-center min-h-[400px]">
                        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200 shadow-lg p-8 text-center max-w-md">
                            ...
                            <h3 className="text-xl font-bold text-yellow-900 mb-2">Access Restricted</h3>
                            <p className="text-yellow-800 mb-4">You don't have permission to view temperature data.</p>
                            <p className="text-sm text-yellow-700">Contact an administrator for access.</p>
                        </div>
                    </div>
                )}
            </main>
